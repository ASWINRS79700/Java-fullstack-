...
public class VehicleService {
    ...
    public int compareMaxSpeed(Vehicle first, Vehicle second) {
        ...
        AbstractManufacturer absFirst = (AbstractManufacturer) first;
        AbstractManufacturer absSecond = (AbstractManufacturer) second;

        if(Objects.equals(absFirst.getType(), "sports") && Objects.equals(absSecond.getType(), "sports"))
        {
